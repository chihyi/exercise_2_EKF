/* Auto-generated by genmsg_cpp for file /home/chihyi/fuerte_workspace/FlyingRobot/ex_2/msg/Navdata.msg */
#ifndef EX_2_MESSAGE_NAVDATA_H
#define EX_2_MESSAGE_NAVDATA_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Navdata_ {
  ...
  typedef boost::shared_ptr< ::ex_2::Navdata_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ex_2::Navdata_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Navdata
typedef  ::ex_2::Navdata_<std::allocator<void> > Navdata;

typedef boost::shared_ptr< ::ex_2::Navdata> NavdataPtr;
typedef boost::shared_ptr< ::ex_2::Navdata const> NavdataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::ex_2::Navdata_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::ex_2::Navdata_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::ex_2::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::ex_2::Navdata_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::ex_2::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "e1169f766234363125ac62c9a3f87eeb";
  }

  static const char* value(const  ::ex_2::Navdata_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xe1169f7662343631ULL;
  static const uint64_t static_value2 = 0x25ac62c9a3f87eebULL;
};

template<class ContainerAllocator>
struct DataType< ::ex_2::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "ex_2/Navdata";
  }
...
template<class ContainerAllocator>
struct Definition< ::ex_2::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::ex_2::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::ex_2::Navdata_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::ex_2::Navdata_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::ex_2::Navdata_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::ex_2::Navdata_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
