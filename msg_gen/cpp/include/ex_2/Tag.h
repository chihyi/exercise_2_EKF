/* Auto-generated by genmsg_cpp for file /home/chihyi/fuerte_workspace/FlyingRobot/ex_2/msg/Tag.msg */
#ifndef EX_2_MESSAGE_TAG_H
#define EX_2_MESSAGE_TAG_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Tag_ {
  ...
  typedef boost::shared_ptr< ::ex_2::Tag_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ex_2::Tag_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Tag
typedef  ::ex_2::Tag_<std::allocator<void> > Tag;

typedef boost::shared_ptr< ::ex_2::Tag> TagPtr;
typedef boost::shared_ptr< ::ex_2::Tag const> TagConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::ex_2::Tag_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::ex_2::Tag_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::ex_2::Tag_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::ex_2::Tag_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::ex_2::Tag_<ContainerAllocator> > {
  static const char* value() 
  {
    return "8506b66f10a2975d80e32037f36b9ab4";
  }

  static const char* value(const  ::ex_2::Tag_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x8506b66f10a2975dULL;
  static const uint64_t static_value2 = 0x80e32037f36b9ab4ULL;
};

template<class ContainerAllocator>
struct DataType< ::ex_2::Tag_<ContainerAllocator> > {
  static const char* value() 
  {
    return "ex_2/Tag";
  }
...
template<class ContainerAllocator>
struct Definition< ::ex_2::Tag_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::ex_2::Tag_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::ex_2::Tag_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::ex_2::Tag_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::ex_2::Tag_<ContainerAllocator> & v) 
  {
    s << indent << "id: ";
