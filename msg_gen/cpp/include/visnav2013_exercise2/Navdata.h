/* Auto-generated by genmsg_cpp for file /home/chihyi/fuerte_workspace/FlyingRobot/visnav2013_exercise2/msg/Navdata.msg */
#ifndef VISNAV2013_EXERCISE2_MESSAGE_NAVDATA_H
#define VISNAV2013_EXERCISE2_MESSAGE_NAVDATA_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Navdata_ {
  ...
  typedef boost::shared_ptr< ::visnav2013_exercise2::Navdata_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::visnav2013_exercise2::Navdata_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Navdata
typedef  ::visnav2013_exercise2::Navdata_<std::allocator<void> > Navdata;

typedef boost::shared_ptr< ::visnav2013_exercise2::Navdata> NavdataPtr;
typedef boost::shared_ptr< ::visnav2013_exercise2::Navdata const> NavdataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::visnav2013_exercise2::Navdata_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::visnav2013_exercise2::Navdata_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::visnav2013_exercise2::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::visnav2013_exercise2::Navdata_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::visnav2013_exercise2::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "e1169f766234363125ac62c9a3f87eeb";
  }

  static const char* value(const  ::visnav2013_exercise2::Navdata_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xe1169f7662343631ULL;
  static const uint64_t static_value2 = 0x25ac62c9a3f87eebULL;
};

template<class ContainerAllocator>
struct DataType< ::visnav2013_exercise2::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "visnav2013_exercise2/Navdata";
  }
...
template<class ContainerAllocator>
struct Definition< ::visnav2013_exercise2::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::visnav2013_exercise2::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::visnav2013_exercise2::Navdata_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::visnav2013_exercise2::Navdata_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::visnav2013_exercise2::Navdata_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::visnav2013_exercise2::Navdata_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // VISNAV2013_EXERCISE2_MESSAGE_NAVDATA_H
