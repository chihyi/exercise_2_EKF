/* Auto-generated by genmsg_cpp for file /home/chihyi/fuerte_workspace/FlyingRobot/exercise_2_EKF/msg/Navdata.msg */
#ifndef EXERCISE_2_EKF_MESSAGE_NAVDATA_H
#define EXERCISE_2_EKF_MESSAGE_NAVDATA_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Navdata_ {
  ...
  typedef boost::shared_ptr< ::exercise_2_EKF::Navdata_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::exercise_2_EKF::Navdata_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Navdata
typedef  ::exercise_2_EKF::Navdata_<std::allocator<void> > Navdata;

typedef boost::shared_ptr< ::exercise_2_EKF::Navdata> NavdataPtr;
typedef boost::shared_ptr< ::exercise_2_EKF::Navdata const> NavdataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::exercise_2_EKF::Navdata_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::exercise_2_EKF::Navdata_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::exercise_2_EKF::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::exercise_2_EKF::Navdata_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::exercise_2_EKF::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "e1169f766234363125ac62c9a3f87eeb";
  }

  static const char* value(const  ::exercise_2_EKF::Navdata_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xe1169f7662343631ULL;
  static const uint64_t static_value2 = 0x25ac62c9a3f87eebULL;
};

template<class ContainerAllocator>
struct DataType< ::exercise_2_EKF::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "exercise_2_EKF/Navdata";
  }
...
template<class ContainerAllocator>
struct Definition< ::exercise_2_EKF::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::exercise_2_EKF::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::exercise_2_EKF::Navdata_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::exercise_2_EKF::Navdata_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::exercise_2_EKF::Navdata_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::exercise_2_EKF::Navdata_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // EXERCISE_2_EKF_MESSAGE_NAVDATA_H
