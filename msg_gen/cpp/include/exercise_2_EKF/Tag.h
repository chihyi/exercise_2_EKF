/* Auto-generated by genmsg_cpp for file /home/chihyi/fuerte_workspace/FlyingRobot/exercise_2_EKF/msg/Tag.msg */
#ifndef EXERCISE_2_EKF_MESSAGE_TAG_H
#define EXERCISE_2_EKF_MESSAGE_TAG_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Tag_ {
  ...
  typedef boost::shared_ptr< ::exercise_2_EKF::Tag_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::exercise_2_EKF::Tag_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Tag
typedef  ::exercise_2_EKF::Tag_<std::allocator<void> > Tag;

typedef boost::shared_ptr< ::exercise_2_EKF::Tag> TagPtr;
typedef boost::shared_ptr< ::exercise_2_EKF::Tag const> TagConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::exercise_2_EKF::Tag_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::exercise_2_EKF::Tag_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::exercise_2_EKF::Tag_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::exercise_2_EKF::Tag_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::exercise_2_EKF::Tag_<ContainerAllocator> > {
  static const char* value() 
  {
    return "8506b66f10a2975d80e32037f36b9ab4";
  }

  static const char* value(const  ::exercise_2_EKF::Tag_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x8506b66f10a2975dULL;
  static const uint64_t static_value2 = 0x80e32037f36b9ab4ULL;
};

template<class ContainerAllocator>
struct DataType< ::exercise_2_EKF::Tag_<ContainerAllocator> > {
  static const char* value() 
  {
    return "exercise_2_EKF/Tag";
  }
...
template<class ContainerAllocator>
struct Definition< ::exercise_2_EKF::Tag_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::exercise_2_EKF::Tag_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::exercise_2_EKF::Tag_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::exercise_2_EKF::Tag_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::exercise_2_EKF::Tag_<ContainerAllocator> & v) 
  {
    s << indent << "id: ";
...
#endif // EXERCISE_2_EKF_MESSAGE_TAG_H
