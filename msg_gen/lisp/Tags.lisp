...
(cl:defclass <Tags> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tags
    :reader tags
    :initarg :tags
    :type (cl:vector ex_2-msg:Tag)
   :initform (cl:make-array 0 :element-type 'ex_2-msg:Tag :initial-element (cl:make-instance 'ex_2-msg:Tag))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Tags>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tags)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ex_2-msg:<Tags> is deprecated: use ex_2-msg:Tags instead.")))
...
(cl:defmethod image_width-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2-msg:image_width-val is deprecated.  Use ex_2-msg:image_width instead.")
  (image_width m))

(cl:ensure-generic-function 'image_height-val :lambda-list '(m))
(cl:defmethod image_height-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2-msg:image_height-val is deprecated.  Use ex_2-msg:image_height instead.")
  (image_height m))

(cl:ensure-generic-function 'angle_of_view-val :lambda-list '(m))
(cl:defmethod angle_of_view-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2-msg:angle_of_view-val is deprecated.  Use ex_2-msg:angle_of_view instead.")
  (angle_of_view m))

(cl:ensure-generic-function 'tag_count-val :lambda-list '(m))
(cl:defmethod tag_count-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2-msg:tag_count-val is deprecated.  Use ex_2-msg:tag_count instead.")
  (tag_count m))

(cl:ensure-generic-function 'tags-val :lambda-list '(m))
(cl:defmethod tags-val ((m <Tags>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex_2-msg:tags-val is deprecated.  Use ex_2-msg:tags instead.")
  (tags m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Tags>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tags)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ex_2-msg:Tag))
